...
Додаткові адміністратори задаються через `ADMIN_IDS=1042869230,123456789` у `.env`.
Вони мають доступ до адмін-панелі та підключення Gmail; зміни потребують перезапуску контейнера.
